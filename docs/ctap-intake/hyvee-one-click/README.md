...
## Live sheet (verified 2026-08-24 21:39 UTC)
- **Licor 43 Crème Brûlée** row is on the Liquor tab (par 3, qty 0, total **$0.00**).
- **Config** tab exists. SEND checkbox is B3.
- Apps Script project **Kenzy Hy-Vee one-tap** is saved on the sheet.
- Still blocked: Google 2FA to install the `onEditInstallable` trigger, Config **B1** Hy-Vee email, share with Kenzy as Editor.

Do not paste Code.gs again. Do not re-send the 8/24 liquor order.
