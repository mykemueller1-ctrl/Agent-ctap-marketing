import { CTAP_OPS_MAILBOX } from "../ctap/intake";
...
/** Humes invoices must land in the CTAP ops mailbox (not founder n86.app). */
export const HUMES_MAILBOX = CTAP_OPS_MAILBOX;
